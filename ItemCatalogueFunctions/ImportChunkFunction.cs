...
// Option 1 trigger: one Storage Queue message = one chunk of 25 (ImportOptions.ChunkSize) items.
// Deliberately a one-line shell — deserialization is the worker's, retries/poison handling are the
// host's (host.json queues.maxDequeueCount), and ALL import logic lives in the shared Application
// core, which is exactly what makes Durable/Service Bus triggers drop-in replacements later.
