...
USING (
    VALUES 
        (1, 'Laptop', 'High-performance laptop with 16GB RAM', 1299.99, 1, 0, NULL, NULL, NULL),
        (2, 'Wireless Mouse', 'Ergonomic wireless mouse with USB receiver', 29.99, 1, 0, NULL, NULL, NULL),
        (3, 'USB-C Cable', '2-meter USB-C charging cable', 12.99, 1, 0, NULL, NULL, NULL),
        (4, 'Monitor Stand', 'Adjustable monitor stand for dual displays', 49.99, 1, 0, NULL, NULL, NULL),
        (5, 'Mechanical Keyboard', 'RGB mechanical keyboard with Cherry MX switches', 149.99, 1, 0, NULL, NULL, NULL)
